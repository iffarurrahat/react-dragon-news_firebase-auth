...
const Login = () => {
    return (
        <div className="bg-[#F3F3F3] mt-0 h-screen w-full flex justify-center items-center">
            <div className="bg-white py-5 md:py-16 w-11/12 md:w-1/2 mx-5 md:mx-auto rounded">
                ...
                <p className=" border-b-2 mx-auto w-2/3 mt-4"></p>
                <form className="card-body w-full md:w-3/4 lg:w-2/3 mx-auto ">
